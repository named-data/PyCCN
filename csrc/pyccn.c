...
static PyMethodDef g_module_methods[] = {
	...
	{"get_default_key", _pyccn_ccn_get_default_key, METH_NOARGS, NULL},
	{"_pyccn_generate_RSA_key", _pyccn_generate_RSA_key, METH_VARARGS,
		""},
	{"PEM_read_key", (PyCFunction) _pyccn_PEM_read_key,
	...
	{"_pyccn_Interest_from_ccn", _pyccn_Interest_from_ccn, METH_O, NULL},
